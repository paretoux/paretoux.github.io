...
Our project aims to design a **novel aerosol** box model which can act as a **replacement for PPE**. For this to be feasible, the box model will need to ensure aerosol containement. 
